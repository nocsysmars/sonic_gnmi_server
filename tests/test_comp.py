...
PATH_GET_COMP_TMPL   = '/components'



class TestComp(test_inc.MyTestCase):
    def test_1_get_comp_info(self):
        TEST_SW_VER_TAG = 'software-version'
        output = self.run_script(['get', PATH_GET_COMP_TMPL, ''])
        self.assertIn(TEST_SW_VER_TAG, output)
