...
class yc_config_openconfig_acl__acl_interfaces_interface_ingress_acl_sets_ingress_acl_set_config(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__set_name = YANGDynClass(base=ReferenceType(referenced_path='../../../../../../acl-sets/acl-set/config/name', caller=self._path() + ['set-name'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="set-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/acl', defining_module='openconfig-acl', yang_type='leafref', is_config=True)
    self.__type = YANGDynClass(base=ReferenceType(referenced_path='../../../../../../acl-sets/acl-set[name=current()/../set-name]/config/type', caller=self._path() + ['type'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/acl', defining_module='openconfig-acl', yang_type='leafref', is_config=True)
...
class yc_state_openconfig_acl__acl_interfaces_interface_ingress_acl_sets_ingress_acl_set_acl_entries_acl_entry_state(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__sequence_id = YANGDynClass(base=ReferenceType(referenced_path='/acl/acl-sets/acl-set[name=current()/../../../../set-name][type=current()/../../../../type]/acl-entries/acl-entry/sequence-id', caller=self._path() + ['sequence-id'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="sequence-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/acl', defining_module='openconfig-acl', yang_type='leafref', is_config=False)
    self.__matched_packets = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="matched-packets", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/acl', defining_module='openconfig-acl', yang_type='oc-yang:counter64', is_config=False)
    self.__matched_octets = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="matched-octets", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/acl', defining_module='openconfig-acl', yang_type='oc-yang:counter64', is_config=False)
...
class yc_acl_entry_openconfig_acl__acl_interfaces_interface_ingress_acl_sets_ingress_acl_set_acl_entries_acl_entry(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__sequence_id = YANGDynClass(base=ReferenceType(referenced_path='../state/sequence-id', caller=self._path() + ['sequence-id'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="sequence-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/acl', defining_module='openconfig-acl', yang_type='leafref', is_config=False)
...
class yc_ingress_acl_set_openconfig_acl__acl_interfaces_interface_ingress_acl_sets_ingress_acl_set(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__set_name = YANGDynClass(base=ReferenceType(referenced_path='../config/set-name', caller=self._path() + ['set-name'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="set-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/acl', defining_module='openconfig-acl', yang_type='leafref', is_config=True)
    self.__type = YANGDynClass(base=ReferenceType(referenced_path='../config/type', caller=self._path() + ['type'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/acl', defining_module='openconfig-acl', yang_type='leafref', is_config=True)
