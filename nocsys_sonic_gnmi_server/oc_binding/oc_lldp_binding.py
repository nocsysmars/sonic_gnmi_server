...
class yc_state_openconfig_lldp__lldp_interfaces_interface_state(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__enabled = YANGDynClass(base=YANGBool, default=YANGBool("true"), is_leaf=True, yang_name="enabled", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='boolean', is_config=False)
    self.__name = YANGDynClass(base=ReferenceType(referenced_path='/oc-if:interfaces/oc-if:interface/oc-if:name', caller=self._path() + ['name'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='oc-if:base-interface-ref', is_config=False)
...
class yc_tlv_openconfig_lldp__lldp_interfaces_interface_neighbors_neighbor_custom_tlvs_tlv(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__oui_subtype = YANGDynClass(base=ReferenceType(referenced_path='../state/oui-subtype', caller=self._path() + ['oui-subtype'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="oui-subtype", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='leafref', is_config=False)
    self.__oui = YANGDynClass(base=ReferenceType(referenced_path='../state/oui', caller=self._path() + ['oui'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="oui", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='leafref', is_config=False)
    self.__type = YANGDynClass(base=ReferenceType(referenced_path='../state/type', caller=self._path() + ['type'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='leafref', is_config=False)
...
neighbor
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__name = YANGDynClass(base=ReferenceType(referenced_path='../state/name', caller=self._path() + ['name'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='leafref', is_config=False)
...
class yc_neighbor_openconfig_lldp__lldp_interfaces_interface_neighbors_neighbor(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__id = YANGDynClass(base=ReferenceType(referenced_path='../state/id', caller=self._path() + ['id'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='leafref', is_config=False)
